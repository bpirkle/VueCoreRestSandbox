...
<template>
	<div id="app" class="app">
		...
		-->
		<h1>{{ $i18n( 'vuecorerestsandbox-app-welcome') }}</h1>
		...
		-->
		<p v-i18n-html:vuecorerestsandbox-app-intro />
...
-->
<script>
var CoreApiRequestModule = require( './CoreApiRequestModule.vue' );

module.exports = {
	name: 'App',
	components: {
		'coreapi-request-module': CoreApiRequestModule
	}
};
</script>
